            ...
            if (javaParameterDTO.getValue() == null) {
                ...
                if (javaClass != null) {
                    ...
                    if (InitConstant.FULLY_COLLECTION_VALUE_IMPORT.keySet().contains(typeToStr)) {
                        ...
                        log.debug("superJavaClass:" + superJavaClass.getFullyQualifiedName() + ",自定义类型" + typeToStr + "，自定义类型中的类型："
                                  + javaParameterDTOList);
                        javaParameterDTO.setJavaParameterDTOList(javaParameterDTOList);
                    }
                ...
                if (javaClass1 != null) {
                    ...
                    if (InitConstant.COLLECTION_VALUE_IMPORT.keySet().contains(fieldType)) {
                        ...
                        if (!javaClassList.isEmpty()) {
                            ...
                            log.info("获取的属性父类信息：" + javaClass2.getFullyQualifiedName() + "，fullyTypeName=" + fullyTypeName + "，javaClass2.getName="
                                     + javaClass2.getName() + "," + javaClass2.getSimpleName());
